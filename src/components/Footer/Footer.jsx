    ...
    <footer className="bg-neutral text-neutral-content">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/myProducts" className="link link-hover">
                  My Products
                </Link>
              </li>
              <li>
                <Link to="/myBids" className="link link-hover">
                  My Bids
                </Link>
              </li>
              <li>
                <Link to="/createAProduct" className="link link-hover">
                  Post Product
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">© 2025 SmartDeals. All rights reserved.</p>
